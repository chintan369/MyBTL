...
public class Order_History_Details extends AppCompatActivity {
    ...
    private void setdata() {
                ...
                /*{
                    ...
                    *//*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                            Toast.LENGTH_SHORT).show();*//*
                                Globals.CustomToast(Order_History_Details.this, "SERVER ERRER", getLayoutInflater());
                                // loadingView.dismiss();
                        ...
                        try {
                            ...
                            if (json2.equalsIgnoreCase("")
                                ...
                                if (date.equalsIgnoreCase("false")) {
                                    ...
                                    Globals.CustomToast(Order_History_Details.this, "" + Message, getLayoutInflater());
                                    loadingView.dismiss();
                                } else {
                                    bean_product1.clear();
        ...
        option_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(Order_History_Details.this, v);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.more_info:
                                ...
                                dialog = new Dialog(Order_History_Details.this);
                                dialog.getWindow();
       ...
       /* String final_full_address = "";
        ...
        //Log.e("abbcbd",""+bean_cart.get(0).getTotal());
        ...
        btn_pay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent i = new Intent(CheckoutPage.this, Btl_Payment.class);
                ...
                final Dialog dialog = new Dialog(Order_History_Details.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    private void setActionBar() {
        ...
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent i = new Intent(Order_History_Details.this, D_OrderHistory.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();*/
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Order_History_Details.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Order_History_Details.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    public void onBackPressed() {
        ...
        /*Intent i = new Intent(Order_History_Details.this, Order_history.class);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        finish();*/
        ...
        protected void onPostExecute(String result_1) {
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                   ...
                   /* Toast.makeText(Business_Registration.this, "SERVER ERRER",
                            Toast.LENGTH_SHORT).show();*/
                    Globals.CustomToast(Order_History_Details.this, "SERVER ERRER", Order_History_Details.this.getLayoutInflater());
                    loadingView.dismiss();
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Globals.CustomToast(Order_History_Details.this, "" + Message, Order_History_Details.this.getLayoutInflater());
                        loadingView.dismiss();
                    } else {
                        ...
                        Intent i = new Intent(Order_History_Details.this, Thankyou_Page.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                        loadingView.dismiss();
...
//            //Log.e("result",result);
    ...
    public class CustomResultAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            //Log.e("ABVJSDHGDFHKJS",""+bean_cart.get(position).getPack_of().toString());
            tv_pack_of.setText(bean_cart.get(position).getPack_of().toString());
            ...
            //Log.e("abcabac",""+bean_cart.get(position).getProduct_total());
            //Log.e("abcbjhiuhikfhdh","h;auhgdih");

            tv_product_total_cost.setText(getResources().getString(R.string.Rs) + "" + bean_cart.get(position).getProduct_total().toString());
            ...
            //Log.e("option Value",""+option_value);
            ...
            reorder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    /*// product_id = tv_pop_pname.getTag().toString();
                    List<NameValuePair> para = new ArrayList<NameValuePair>();
                    para.add(new BasicNameValuePair("product_id", bean_cart.get(position).getProduct_id()));
                    para.add(new BasicNameValuePair("owner_id", owner_id));
                    para.add(new BasicNameValuePair("user_id", u_id));
                    ...
                    Globals.generateNoteOnSD(getApplicationContext(), "2248");
                    ...
                    Globals.generateNoteOnSD(getApplicationContext(), "2257");
                    ...
                    *//*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                    ...
                    String json2 = jsonData;

                    Globals.generateNoteOnSD(getApplicationContext(), "2323");
                    //String json2 = GetProductDetailByProductDetail(params);
                    //product_id = tv_pop_pname.getTag().toString();
                    ...
                    Globals.generateNoteOnSD(getApplicationContext(), "2546");
    ...
    public class set_order_tracking extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingView = new Custom_ProgressDialog(Order_History_Details.this, "");
...
//            reorder.setVisibility(View.VISIBLE);
    ...
    private class GetProductDetailByProductDetail extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            Globals.generateNoteOnSD(getApplicationContext(), pairList.toString() + " -> " + isNotDone + " -> " + jsonData);
    ...
    private class GetOrderEnquiry extends AsyncTask<Void, Void, String> {
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        // Globals.CustomToast(Product_List.this, "Item insert in cart", getLayoutInflater());
                        Intent i = new Intent(Order_History_Details.this, Order_History_Details.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                    }
            ...
            try {
                ...
                if (json == null
                    ...
                    if (userStatus.equals("0")) {
                        C.userInActiveDialog(Order_History_Details.this);
                    }
                    String date = jObj.getString("status");
