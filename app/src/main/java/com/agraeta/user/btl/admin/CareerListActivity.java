...
public class CareerListActivity extends AppCompatActivity implements Callback<CareerData> {
    ...
    Call<CareerData> careerDataCall;
    ...
    private void fetchIDs() {
        ...
        careerListAdapter=new CareerListAdapter(careerDetailList,this);
        list_enquiries.setAdapter(careerListAdapter);

        txt_enquiryName.setText(enquiryName);

        progressDialog.show();

        careerDataCall=adminAPI.careerDataCall(null,null,page);
        careerDataCall.enqueue(this);
    ...
    private void showFilterDialog() {
        ...
        edt_fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(CareerListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    @Override
    public void onResponse(Call<CareerData> call, Response<CareerData> response) {
        progressDialog.dismiss();

        CareerData data=response.body();
        if(data.isStatus()){
            page++;
            careerDetailList.addAll(data.getCareerDetailList());
            careerListAdapter.notifyDataSetChanged();
    ...
    @Override
    public void onFailure(Call<CareerData> call, Throwable t) {
        progressDialog.dismiss();
