 ...
 */
public class Bean_ProductOprtionwishlist {

    private int id ;
    private String pro_id = new String();
    private String option_pro_id = new String();
    ...
    public Bean_ProductOprtionwishlist(){

    }

    public Bean_ProductOprtionwishlist(int id, String pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.id = id;
        this.pro_id = pro_id;
    ...
    public Bean_ProductOprtionwishlist(String pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.pro_id = pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Option_id = pro_Option_id;
        this.pro_Option_name = pro_Option_name;
    ...
    public Bean_ProductOprtionwishlist(int id, String pro_id, String option_pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.id = id;
        this.pro_id = pro_id;
        this.option_pro_id = option_pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Option_id = pro_Option_id;
        this.pro_Option_name = pro_Option_name;
        this.pro_Option_value_id = pro_Option_value_id;
    ...
    public Bean_ProductOprtionwishlist(String pro_id, String option_pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.pro_id = pro_id;
        this.option_pro_id = option_pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Option_id = pro_Option_id;
    ...
    public String getOption_pro_id() {
        return option_pro_id;
    }

    public void setOption_pro_id(String option_pro_id) {
        this.option_pro_id = option_pro_id;
    }
