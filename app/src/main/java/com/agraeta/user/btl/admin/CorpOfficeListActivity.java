...
public class CorpOfficeListActivity extends AppCompatActivity implements Callback<CorporateOfficeData> {

    Custom_ProgressDialog progressDialog;
    CorpOfficeListAdapter officeListAdapter;
    ...
    String fromDate = "";
    String toDate = "";
    Call<CorporateOfficeData> officeDataCall;
    AdminAPI adminAPI;
    ...
    private void fetchIDs() {
        ...
        officeListAdapter=new CorpOfficeListAdapter(officeDetailList,this);
        list_enquiries.setAdapter(officeListAdapter);
    ...
    private void showFilterDialog() {
        ...
        edt_fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(CorpOfficeListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!fromDate.isEmpty() && !toDate.isEmpty()) {
                    ...
                    page = 1;
                    totalPage = 1;
                    officeDataCall.cancel();
                    officeDetailList.clear();
                    officeListAdapter.notifyDataSetChanged();
                    officeDataCall = adminAPI.officeDataCall(fromDate, toDate, page);
                    officeDataCall.enqueue(CorpOfficeListActivity.this);
                } else {
    ...
    @Override
    public void onResponse(Call<CorporateOfficeData> call, Response<CorporateOfficeData> response) {
        progressDialog.dismiss();
        CorporateOfficeData data=response.body();
        if(data.isStatus()){
            page++;
    ...
    @Override
    public void onFailure(Call<CorporateOfficeData> call, Throwable t) {
        progressDialog.dismiss();
