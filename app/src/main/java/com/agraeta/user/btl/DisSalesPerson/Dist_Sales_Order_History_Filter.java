 ...
 */
public class Dist_Sales_Order_History_Filter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(Dist_Sales_Order_History_Filter.this);
        appPrefs = new AppPrefs(Dist_Sales_Order_History_Filter.this);
    ...
    private void setActionBar() {
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(Dist_Sales_Order_History_Filter.this);
                appPrefs.setUser_notification("Dist_Sales_Order_History_Filter");
                Intent i = new Intent(Dist_Sales_Order_History_Filter.this, BTL_Cart.class);
        ...
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Dist_Sales_Order_History_Filter.this, Dist_SalesOrderHistory.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dist_Sales_Order_History_Filter.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dist_Sales_Order_History_Filter.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    private void fetchID()
    {
        ...
        clear_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Dist_Sales_Order_History_Filter.this,Dist_Sales_Order_History_Filter.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
    ...
    {
        dialog = new Dialog(Dist_Sales_Order_History_Filter.this);
        ...
        ed_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fromDatePickerDialog = new DatePickerDialog(Dist_Sales_Order_History_Filter.this, new DatePickerDialog.OnDateSetListener() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Globals.CustomToast(Dist_Sales_Order_History_Filter.this,"Please enter from date",getLayoutInflater());
                } else if(ed_to_date.getText().toString().equalsIgnoreCase(""))
                {
                    Globals.CustomToast(Dist_Sales_Order_History_Filter.this,"Please enter to date",getLayoutInflater());
                }
                else {
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if (json==null
                    ...
                    Globals.CustomToast(Dist_Sales_Order_History_Filter.this, "SERVER ERRER", getLayoutInflater());
                    // loadingView.dismiss();
                } else {
                    JSONObject jObj = new JSONObject(json);
                    String userStatus = jObj.getString("user_status");
                    if (userStatus.equals("0")) {
                        C.userInActiveDialog(Dist_Sales_Order_History_Filter.this);
                    }
