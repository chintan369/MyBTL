 ...
 */
public class Dist_Sales_Order_History_Details extends AppCompatActivity {
...
//    String role_id = new String();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(Dist_Sales_Order_History_Details.this);
                ...
                /*for (int ii = 0; ii < ij; ii++) {
                    ...
                    *//*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                            Toast.LENGTH_SHORT).show();*//*
                                Globals.CustomToast(Dist_Sales_Order_History_Details.this, "SERVER ERRER", getLayoutInflater());
                                // loadingView.dismiss();
                        ...
                        try {
                            ...
                            if (json2.equalsIgnoreCase("")
                                ...
                                if (date.equalsIgnoreCase("false")) {
                                    ...
                                    Globals.CustomToast(Dist_Sales_Order_History_Details.this, "" + Message, getLayoutInflater());
                                    loadingView.dismiss();
                                } else {
                                    bean_product1.clear();
        ...
        option_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu=new PopupMenu(Dist_Sales_Order_History_Details.this,v);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.more_info:
                                ...
                                dialog = new Dialog(Dist_Sales_Order_History_Details.this);
                                dialog.getWindow();
        ...
        btn_pay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent i = new Intent(CheckoutPage.this, Btl_Payment.class);
                ...
                final Dialog dialog = new Dialog(Dist_Sales_Order_History_Details.this,android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    private void setActionBar() {
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(Dist_Sales_Order_History_Details.this);
                appPrefs.setUser_notification("Dist_Sales_Order_History_Details");
                Intent i = new Intent(Dist_Sales_Order_History_Details.this, BTL_Cart.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Dist_Sales_Order_History_Details.this, Dist_SalesOrderHistory.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dist_Sales_Order_History_Details.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dist_Sales_Order_History_Details.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        ...
        protected void onPreExecute() {
            ...
            try {
                loadingView = new Custom_ProgressDialog(
                        Dist_Sales_Order_History_Details.this, "");
        ...
        protected void onPostExecute(String result_1) {
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                   ...
                   /* Toast.makeText(Business_Registration.this, "SERVER ERRER",
                            Toast.LENGTH_SHORT).show();*/
                    Globals.CustomToast(Dist_Sales_Order_History_Details.this, "SERVER ERRER", Dist_Sales_Order_History_Details.this.getLayoutInflater());
                    loadingView.dismiss();
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Globals.CustomToast(Dist_Sales_Order_History_Details.this, "" + Message, Dist_Sales_Order_History_Details.this.getLayoutInflater());
                        loadingView.dismiss();
                    } else {
                        ...
                        Intent i = new Intent(Dist_Sales_Order_History_Details.this,Thankyou_Page.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                        loadingView.dismiss();
...
//            //Log.e("result",result);
    ...
    public class set_order_tracking extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingView = new Custom_ProgressDialog(Dist_Sales_Order_History_Details.this, "");
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        // Globals.CustomToast(Product_List.this, "Item insert in cart", getLayoutInflater());
                        Intent i = new Intent(Dist_Sales_Order_History_Details.this, Dist_Sales_Order_History_Details.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                    }
