 ...
 */
public class Bean_ProductCartwishlist {
    ...
    private String pro_schme = new String();
    private String pro_schme_name = new String();
    ...
    public Bean_ProductCartwishlist()
    {

    }

    public Bean_ProductCartwishlist(int id, String pro_id, String pro_cat_id, String pro_Images, String pro_code, String pro_name, String pro_qty, String pro_mrp, String pro_sellingprice, String pro_shortdesc, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_total) {
        this.id = id;
        this.pro_id = pro_id;
    ...
    public Bean_ProductCartwishlist(int id, String pro_id, String pro_cat_id, String pro_Images, String pro_code, String pro_name, String pro_qty, String pro_mrp, String pro_sellingprice, String pro_shortdesc, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_total, String pro_schme) {
        this.id = id;
        this.pro_id = pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Images = pro_Images;
        ...
        this.pro_Option_value_name = pro_Option_value_name;
        this.pro_total = pro_total;
        this.pro_schme = pro_schme;
    }

    public Bean_ProductCartwishlist(String pro_id, String pro_cat_id, String pro_Images, String pro_code, String pro_name, String pro_qty, String pro_mrp, String pro_sellingprice, String pro_shortdesc, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_total, String pro_schme) {
        this.pro_id = pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Images = pro_Images;
        this.pro_code = pro_code;
    ...
    public Bean_ProductCartwishlist(int id, String pro_id, String pro_cat_id, String pro_Images, String pro_code, String pro_name, String pro_qty, String pro_mrp, String pro_sellingprice, String pro_shortdesc, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_total, String pro_schme, String pro_schme_name) {
        this.id = id;
        this.pro_id = pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Images = pro_Images;
        ...
        this.pro_total = pro_total;
        this.pro_schme = pro_schme;
        this.pro_schme_name = pro_schme_name;
    }

    public String getPro_schme_name() {
        return pro_schme_name;
    }

    public void setPro_schme_name(String pro_schme_name) {
        this.pro_schme_name = pro_schme_name;
    }

    public String getPro_schme() {
        return pro_schme;
    }

    public void setPro_schme(String pro_schme) {
        this.pro_schme = pro_schme;
    }
