...
public class Add_Newuser_Address extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id_main = intent.getStringExtra("USER_ID");
    ...
    private void fetchId()
    {
        ...
        spn_country.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                imm.hideSoftInputFromWindow(et_addline1.getWindowToken(), 0);
                return false;
            }
        }) ;
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (et_addline1.getText().toString().equalsIgnoreCase("")) {
                    Globals.CustomToast(Add_Newuser_Address.this, "Please Enter Address Line1", getLayoutInflater());
                    et_addline1.requestFocus();
                } else if (et_pincode.getText().toString().equalsIgnoreCase("")) {
                    Globals.CustomToast(Add_Newuser_Address.this, "Please Enter Address Pincode", getLayoutInflater());
                    et_pincode.requestFocus();
                } else if (et_pincode.length() < 6) {
                    Globals.CustomToast(Add_Newuser_Address.this, "Pincode 6 character required", getLayoutInflater());
                    et_pincode.requestFocus();
                }else if (position_country.equalsIgnoreCase("0")) {
                    Globals.CustomToast(Add_Newuser_Address.this, "Please Select Country", getLayoutInflater());
...
//                    Globals.CustomToast(Add_Newuser_Address.this,"Please Select City",getLayoutInflater());
    ...
    private void setActionBar() {
       ...
       /* setRefershData();
            ...
            try {
                ...
                if (json==null
                    ...
                    *//*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                    ...
                    Globals.CustomToast(Add_Newuser_Address.this, "SERVER ERRER", getLayoutInflater());
                    // loadingView.dismiss();
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                app = new AppPrefs(Add_Newuser_Address.this);
                app.setUser_notification("Add_Newuser_Address");
        ...
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Add_Newuser_Address.this,Notification.class);
                startActivity(i);
            }
        });
        img_cart.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Add_Newuser_Address.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    public class send_state_Data extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingView = new Custom_ProgressDialog(Add_Newuser_Address.this, "");
        ...
        protected void onPostExecute(String result_1) {
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    /*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                            Toast.LENGTH_SHORT).show();*/
                    Globals.CustomToast(Add_Newuser_Address.this, "SERVER ERROR", getLayoutInflater());
                    loadingView.dismiss();
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Globals.CustomToast(Add_Newuser_Address.this, "" + Message, getLayoutInflater());
                        loadingView.dismiss();
                    } else {
                        JSONObject jobj = new JSONObject(result_1);
                        ...
                        if (jobj != null) {
                            ...
                            for (int i = 0; i < categories.length(); i++) {
                                ...
                                ArrayAdapter<String> adapter_state = new ArrayAdapter<String>(Add_Newuser_Address.this, android.R.layout.simple_spinner_item, statename);
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        if (jobj != null) {
                            ...
                            for (int i = 0; i < categories.length(); i++) {
                                ...
                                ArrayAdapter<String> adapter_city = new ArrayAdapter<String>(Add_Newuser_Address.this, android.R.layout.simple_spinner_item, cityname);
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        if (jobj != null) {
                            ...
                            for (int i = 0; i < categories.length(); i++) {
                                ...
                                ArrayAdapter<String> adapter_city = new ArrayAdapter<String>(Add_Newuser_Address.this, android.R.layout.simple_spinner_item, countryname);
                                adapter_city.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        if(app.getfi_name().toString().equalsIgnoreCase("")||app.getfi_name().toString().equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = app.getfi_name().toString();
                        }

                        if(app.getphone().toString().equalsIgnoreCase("")||app.getphone().toString().equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = app.getphone().toString();
                        }
                        ...
                        {
                            final_address = final_address+", "+ add2;
                        }
                        ...
                        if(et_landmark.getText().toString().equalsIgnoreCase("")||et_landmark.getText().toString().equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = final_address+", "+ et_landmark.getText().toString();
                        }

                        if(position_cityname.equalsIgnoreCase("")||position_cityname.equalsIgnoreCase("null"))
                        {
                        ...
                        if(et_pincode.getText().toString().equalsIgnoreCase("")||et_pincode.getText().toString().equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = final_address+"-"+ et_pincode.getText().toString();
                        }

                        if(position_statename.equalsIgnoreCase("")||position_statename.equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = final_address+", "+ position_statename;
                        }

                        if(position_countryname.equalsIgnoreCase("")||position_countryname.equalsIgnoreCase("null"))
                        {

                        }
                        else
                        {
                            final_address = final_address+", "+ position_countryname;
                        }

                        app.setaddress_id(final_address);
                        app.seta_id(jObj.getString("data"));
