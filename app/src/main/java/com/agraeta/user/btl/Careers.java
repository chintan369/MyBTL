...
public class Careers<Contact_Adapter_new> extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_carreers__html, container, false);
        getActivity().getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        app= new AppPrefs(getActivity());
        app.setjobid("");
        app.setjobname("");
    ...
    public class Contact_Adapter1 extends ArrayAdapter<Bean_JobVacancy> {
        ...
        public Contact_Adapter1(Activity act, int layoutResourceId,
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder1.btn_apply1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Log.e("data_id", "" + data.get(position).getVid());
                    Intent i = new Intent(getActivity(),career_activity.class);
...
*/
                            ...
                            cAdapter1 = new Contact_Adapter1(getActivity(), R.layout.vacancies_row,
                                    category_data1);
