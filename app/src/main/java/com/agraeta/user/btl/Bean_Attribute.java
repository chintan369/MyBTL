...
public class Bean_Attribute {
    ...
    public Bean_Attribute(String option_id, String option_name, String value_id, String value_name, String value_mrp, String value_image, String value_product_code, String value_selling_price, String pro_id) {
        this.option_id = option_id;
        this.option_name = option_name;
        this.value_id = value_id;
        this.value_name = value_name;
    ...
    public Bean_Attribute(String option_id, String option_name, String value_id, String value_name, String value_mrp, String value_image, String value_product_code, String value_selling_price, String pro_id, String option_pro_id) {
        this.option_id = option_id;
        this.option_name = option_name;
        this.value_id = value_id;
        this.value_name = value_name;
