...
public class D_OrderHistoryFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(D_OrderHistoryFilter.this);
        appPrefs = new AppPrefs(D_OrderHistoryFilter.this);
    ...
    private void setActionBar() {
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(D_OrderHistoryFilter.this);
                appPrefs.setUser_notification("D_OrderHistoryFilter");
                Intent i = new Intent(D_OrderHistoryFilter.this, BTL_Cart.class);
        ...
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(D_OrderHistoryFilter.this, D_OrderHistory.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(D_OrderHistoryFilter.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(D_OrderHistoryFilter.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    private void fetchID()
    {
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String s1 = appPrefs.getOrder_history_filter_order_status();
                String t1=appPrefs.getOrder_history_filter_to_date();
                String t2=appPrefs.getOrder_history_filter_from_date();
                String s4=appPrefs.getOrder_history_filter_predefine();
                if(s1.equalsIgnoreCase("") && t1.equalsIgnoreCase("") && t2.equalsIgnoreCase("") && s4.equalsIgnoreCase("")){

                    Globals.CustomToast(D_OrderHistoryFilter.this,"Please Select Status or Date",getLayoutInflater());
                }else {
        ...
        clear_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(D_OrderHistoryFilter.this,D_OrderHistoryFilter.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
    ...
    {
        dialog = new Dialog(D_OrderHistoryFilter.this);
        ...
        ed_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fromDatePickerDialog = new DatePickerDialog(D_OrderHistoryFilter.this, new DatePickerDialog.OnDateSetListener() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Globals.CustomToast(D_OrderHistoryFilter.this,"Please enter from date",getLayoutInflater());
                } else if(ed_to_date.getText().toString().equalsIgnoreCase(""))
                {
                    Globals.CustomToast(D_OrderHistoryFilter.this,"Please enter to date",getLayoutInflater());
                }
                else {
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if (json==null
                    ...
                    Globals.CustomToast(D_OrderHistoryFilter.this, "SERVER ERRER", getLayoutInflater());
                    // loadingView.dismiss();
                } else {
                    JSONObject jObj = new JSONObject(json);
                    String userStatus = jObj.getString("user_status");
                    if (userStatus.equals("0")) {
                        C.userInActiveDialog(D_OrderHistoryFilter.this);
                    }
