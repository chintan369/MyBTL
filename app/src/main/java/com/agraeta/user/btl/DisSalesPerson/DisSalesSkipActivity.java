...
import com.agraeta.user.btl.CompanySalesPerson.Bean_Company_Sales_User;
...
public class DisSalesSkipActivity extends AppCompatActivity implements Serializable {
    Spinner spn_reason;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_sales_skip);
        ...
        userDisSalesID=intent.getStringExtra("salesDistributorPerson");
        //Log.e("userid in skip order",""+userDisSalesID);
                ...
                alertDialog.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                apps = new AppPrefs(DisSalesSkipActivity.this);
                                if (apps.getUser_LoginWith().equalsIgnoreCase("0")) {
                                    ...
                                    db = new DatabaseHandler(DisSalesSkipActivity.this);
                                    db.Delete_user_table();
                                    db.Clear_ALL_table();
                                    db.close();
                                    Intent i = new Intent(DisSalesSkipActivity.this, MainPage_drawer.class);
...
//                startActivityForResult(intent1,SELECT_PICTURE);
            ...
            public void onClick(View v) {
                ...
                if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    if (spn_reason.getSelectedItemPosition() == 0) {
                        ...
                        params.add(new BasicNameValuePair("user_id", apps.getDsalesId()));
                        params.add(new BasicNameValuePair("skip_person_id", userDisSalesID));
    ...
    public class SendReason extends AsyncTask<Void, Void, String> {
        ...
        public SendReason(List<NameValuePair> parameters){
            dialog=new Custom_ProgressDialog(DisSalesSkipActivity.this,"");
