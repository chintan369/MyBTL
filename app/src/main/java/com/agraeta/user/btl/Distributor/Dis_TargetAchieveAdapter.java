 ...
 * Created by SEO on 9/29/2016.
 */
public class Dis_TargetAchieveAdapter extends BaseAdapter {
    ...
    public Dis_TargetAchieveAdapter(Context context, List<BeanTargetAchieve> targetAchieveList, Activity activity) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        view = inflater.inflate(R.layout.custom_target_layout_7, parent, false);

        final BeanTargetAchieve targetAchieve = targetAchieveList.get(position);

        TextView lstName = (TextView) view.findViewById(R.id.lst_name);
        ...
        lstName.setText(targetAchieve.getSalesName());
