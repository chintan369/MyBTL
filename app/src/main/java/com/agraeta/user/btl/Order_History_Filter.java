...
public class Order_History_Filter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(Order_History_Filter.this);
        appPrefs = new AppPrefs(Order_History_Filter.this);
    ...
    private void setActionBar() {
       ...
       /* setRefershData();
            ...
            try {
                ...
                if (json==null
                    ...
                    *//*Toast.makeText(Business_Registration.this, "SERVER ERRER",
                    ...
                    Globals.CustomToast(Order_History_Filter.this, "SERVER ERRER", getLayoutInflater());
                    // loadingView.dismiss();
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(Order_History_Filter.this);
                appPrefs.setUser_notification("Order_History_Filter");
                Intent i = new Intent(Order_History_Filter.this, BTL_Cart.class);
        ...
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Order_History_Filter.this, Order_history.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Order_History_Filter.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Order_History_Filter.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    private void fetchID()
    {
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(s1.equalsIgnoreCase("") && t1.equalsIgnoreCase("") && t2.equalsIgnoreCase("") && s4.equalsIgnoreCase("")){
                    ...
                    Globals.CustomToast(Order_History_Filter.this,"Please Select Status or Date",getLayoutInflater());
                }else {
        ...
        clear_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Order_History_Filter.this,Order_History_Filter.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
    ...
    {
        dialog = new Dialog(Order_History_Filter.this);
        ...
        ed_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fromDatePickerDialog = new DatePickerDialog(Order_History_Filter.this, new DatePickerDialog.OnDateSetListener() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Globals.CustomToast(Order_History_Filter.this,"Please enter from date",getLayoutInflater());
                } else if(ed_to_date.getText().toString().equalsIgnoreCase(""))
                {
                    Globals.CustomToast(Order_History_Filter.this,"Please enter to date",getLayoutInflater());
                }
                else {
