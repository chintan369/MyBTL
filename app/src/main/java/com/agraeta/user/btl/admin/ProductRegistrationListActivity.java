...
import com.agraeta.user.btl.adapters.ProductRegistrationListAdapter;
...
public class ProductRegistrationListActivity extends AppCompatActivity implements Callback<ProductRegistrationData> {

    Custom_ProgressDialog progressDialog;
    ProductRegistrationListAdapter registrationListAdapter;
    ...
    String fromDate = "";
    String toDate = "";
    Call<ProductRegistrationData> registrationDataCall;
    AdminAPI adminAPI;
    ...
    private void fetchIDs() {
        ...
        registrationListAdapter=new ProductRegistrationListAdapter(registrationDetailList,this);
        list_enquiries.setAdapter(registrationListAdapter);
        txt_enquiryName.setText(enquiryName);
        progressDialog.show();
        registrationDataCall=adminAPI.registrationDataCall(null,null,page);
        registrationDataCall.enqueue(this);
    }
    ...
    private void showFilterDialog() {
        ...
        edt_fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ProductRegistrationListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!fromDate.isEmpty() && !toDate.isEmpty()) {
                    ...
                    page = 1;
                    totalPage = 1;
                    registrationDataCall.cancel();
                    registrationDetailList.clear();
                    registrationListAdapter.notifyDataSetChanged();
                    registrationDataCall = adminAPI.registrationDataCall(fromDate, toDate, page);
                    registrationDataCall.enqueue(ProductRegistrationListActivity.this);
                } else {
    ...
    @Override
    public void onResponse(Call<ProductRegistrationData> call, Response<ProductRegistrationData> response) {
        progressDialog.dismiss();
        ProductRegistrationData data=response.body();

        if(data.isStatus()){
            page++;
            registrationDetailList.addAll(data.getRegistrationDetailList());
            registrationListAdapter.notifyDataSetChanged();
    ...
    @Override
    public void onFailure(Call<ProductRegistrationData> call, Throwable t) {
        progressDialog.dismiss();
