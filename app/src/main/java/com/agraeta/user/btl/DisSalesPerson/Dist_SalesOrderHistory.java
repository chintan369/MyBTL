...
public class Dist_SalesOrderHistory extends AppCompatActivity {
    ...
    private void fetchID()
    {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.Delete_Order_histroy();
                Intent i = new Intent(Dist_SalesOrderHistory.this,Dist_SalesOrderHistory.class);
        ...
        lin_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Dist_SalesOrderHistory.this,Dist_Sales_Order_History_Filter.class);
    ...
    public class CustomAdapterOrderHistory extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Dist_SalesOrderHistory.this, Dist_Sales_Order_History_Details.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            img_options.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    PopupMenu menu=new PopupMenu(Dist_SalesOrderHistory.this,v);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            switch (item.getItemId()){
                                ...
                                case R.id.menu_invoice:
                                    ...
                                    dialog = new Dialog(Dist_SalesOrderHistory.this);
                                    dialog.getWindow();
        ...
        class DownloadFileFromURL extends AsyncTask<String, String, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = new ProgressDialog(Dist_SalesOrderHistory.this);
    ...
    public class get_order_history extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingView = new Custom_ProgressDialog(Dist_SalesOrderHistory.this, "");
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                   ...
                   /* Toast.makeText(Business_Registration.this, "SERVER ERRER",
                    ...
                    Globals.CustomToast(Dist_SalesOrderHistory.this, "SERVER ERRER", Dist_SalesOrderHistory.this.getLayoutInflater());
                    loadingView.dismiss();
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Globals.CustomToast(Dist_SalesOrderHistory.this, "" + Message, Dist_SalesOrderHistory.this.getLayoutInflater());
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if (json==null
                    ...
                    Globals.CustomToast(Dist_SalesOrderHistory.this, "SERVER ERRER", getLayoutInflater());
                    // loadingView.dismiss();
                } else {
