...
public class SalesOrderHistory extends AppCompatActivity {
    ...
    private void fetchID()
    {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.Delete_Order_histroy();
                Intent i = new Intent(SalesOrderHistory.this,SalesOrderHistory.class);
        ...
        lin_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SalesOrderHistory.this,Sales_Order_History_Filter.class);
    ...
    private void setActionBar() {
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(SalesOrderHistory.this);
                appPrefs.setUser_notification("SalesOrderHistory");
                Intent i = new Intent(SalesOrderHistory.this, BTL_Cart.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        image_drawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.Delete_Order_histroy();
                Intent i = new Intent(SalesOrderHistory.this, UserListActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
            }
      ...
      /*  img_category.setOnClickListener(new View.OnClickListener() {
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SalesOrderHistory.this, MainPage_drawer.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
        img_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SalesOrderHistory.this, Notification.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            }
        });
    ...
    public class CustomAdapterOrderHistory extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Log.e("DEF",""+bean_inv.get(position).getOrder_invoice().toString());
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(SalesOrderHistory.this, Sales_Order_History_Details.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            img_options.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    PopupMenu menu=new PopupMenu(SalesOrderHistory.this,v);
          ...
          /*  setRefershData();
            ...
            if(user_data.size() != 0) {
                for (int i = 0; i < user_data.size(); i++) {
                    ...
                    role = user_data.get(i).getUser_type().toString();

                    if (role.equalsIgnoreCase("6")) {
            ...
            if (role_id.equalsIgnoreCase("3") && role.equalsIgnoreCase("6")) {
                ...
                im_pdfdownload.setVisibility(View.INVISIBLE);
                im_invoice.setVisibility(View.INVISIBLE);
            }else{
                tv_total.setVisibility(View.VISIBLE);
                im_pdfdownload.setVisibility(View.VISIBLE);
                if(bean_inv.get(position).getOrder_invoice().toString().equalsIgnoreCase("0")){
                    im_invoice.setVisibility(View.INVISIBLE);
                }else{
                    im_invoice.setVisibility(View.VISIBLE);
...
//            });
            ...
            im_invoice.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog = new Dialog(SalesOrderHistory.this);
                    dialog.getWindow();
        ...
        class DownloadFileFromURL extends AsyncTask<String, String, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = new ProgressDialog(SalesOrderHistory.this);
    ...
    public class get_order_history extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingView = new Custom_ProgressDialog(SalesOrderHistory.this, "");
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                   ...
                   /* Toast.makeText(Business_Registration.this, "SERVER ERRER",
                    ...
                    Globals.CustomToast(SalesOrderHistory.this, "SERVER ERRER", SalesOrderHistory.this.getLayoutInflater());
                    loadingView.dismiss();
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Globals.CustomToast(SalesOrderHistory.this, "" + Message, SalesOrderHistory.this.getLayoutInflater());
                        ...
                        for(int i = 0 ; i < jarray_data.length() ; i ++)
                        {
                            ...
                            Log.e("ABC",""+jobject_main.getString("OrderInvoice").toString());
                            bean_inv.add(bea);
                            ...
                            for(int j = 0 ; j <jarray_OrderProduct.length() ; j ++)
                            {
                                ...
                                Log.e("abc",""+jobject_OrderProduct.getString("pack_of"));
...
//            //Log.e("result",result);
    ...
    //  int current_position1 = -1;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            txt_no.setText(bean_invoice.get(position).getIno());
            txt_date.setText(bean_invoice.get(position).getIdate());
            txt_total.setText(getResources().getString(R.string.Rs)+""+bean_invoice.get(position).getItotal());
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if (json==null
                    ...
                    Globals.CustomToast(SalesOrderHistory.this, "SERVER ERROR", getLayoutInflater());
                    // loadingView.dismiss();
                } else {
                    JSONObject jObj = new JSONObject(json);
                    String userStatus = jObj.getString("user_status");
                    if (userStatus.equals("0")) {
                        C.userInActiveDialog(SalesOrderHistory.this);
                    }
                    String date = jObj.getString("status");
