...
import com.agraeta.user.btl.adapters.CustomerComplaintListAdapter;
...
public class CustomerComplaintActivity extends AppCompatActivity implements Callback<CustomerComplaintData> {

    Custom_ProgressDialog progressDialog;

    CustomerComplaintListAdapter complaintListAdapter;
    ...
    Call<CustomerComplaintData> complaintDataCall;
    AdminAPI adminAPI;
    ...
    private void showFilterDialog() {
        ...
        edt_fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(CustomerComplaintActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!fromDate.isEmpty() && !toDate.isEmpty()) {
                    ...
                    page = 1;
                    totalPage = 1;
                    complaintDataCall.cancel();
                    complaintDetailList.clear();
                    complaintListAdapter.notifyDataSetChanged();
                    complaintDataCall = adminAPI.complaintDataCall(fromDate, toDate, page);
                    complaintDataCall.enqueue(CustomerComplaintActivity.this);
                } else {
    ...
    private void fetchIDs() {
        ...
        complaintListAdapter=new CustomerComplaintListAdapter(complaintDetailList,this);
        list_enquiries.setAdapter(complaintListAdapter);

        txt_enquiryName.setText(enquiryName);

        progressDialog.show();

        complaintDataCall=adminAPI.complaintDataCall(null,null,page);
        complaintDataCall.enqueue(this);
    }

    @Override
    public void onResponse(Call<CustomerComplaintData> call, Response<CustomerComplaintData> response) {
        progressDialog.dismiss();
        CustomerComplaintData data=response.body();

        if(data.isStatus()){
            page++;
            complaintDetailList.addAll(data.getComplaintDetailList());
            complaintListAdapter.notifyDataSetChanged();
    ...
    @Override
    public void onFailure(Call<CustomerComplaintData> call, Throwable t) {
        progressDialog.dismiss();
