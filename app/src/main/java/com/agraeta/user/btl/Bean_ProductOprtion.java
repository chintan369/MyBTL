...
public class Bean_ProductOprtion {
    ...
    public Bean_ProductOprtion(int id, String pro_id, String option_pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.id = id;
        this.pro_id = pro_id;
    ...
    public Bean_ProductOprtion(String pro_id, String option_pro_id, String pro_cat_id, String pro_Option_id, String pro_Option_name, String pro_Option_value_id, String pro_Option_value_name, String pro_Option_mrp, String pro_Option_selling_price, String pro_Option_proimage, String pro_Option_procode) {
        this.pro_id = pro_id;
        this.option_pro_id = option_pro_id;
        this.pro_cat_id = pro_cat_id;
        this.pro_Option_id = pro_Option_id;
