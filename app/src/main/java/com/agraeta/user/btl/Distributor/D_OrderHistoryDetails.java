    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reorder_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Custom_ProgressDialog dialogLoad = new Custom_ProgressDialog(D_OrderHistoryDetails.this, "");
...
//                        List<NameValuePair> para = new ArrayList<NameValuePair>();
//                        para.add(new BasicNameValuePair("product_id", bean_cart.get(ii).getProduct_id()));
//                        para.add(new BasicNameValuePair("owner_id", owner_id));
//                        para.add(new BasicNameValuePair("user_id", u_id));
...
//
//                        Log.e("Current Qty","- - ->"+bean_cart.get(ii).getProduct_qty());
//
//                        isNotDone=true;
...
//                                Globals.CustomToast(D_OrderHistoryDetails.this, "SERVER ERRER", getLayoutInflater());
//                                // loadingView.dismiss();
//
//                            } else {
...
//
//                                    Globals.CustomToast(D_OrderHistoryDetails.this, "" + Message, getLayoutInflater());
//                                    loadingView.dismiss();
//                                } else {
//                                    bean_product1.clear();
...
//                                    jobject.put("quantity",  bean_cart.get(ii).getProduct_qty());
...
//                }
                ...
                //Globals.CustomToast(getApplicationContext(),"Product(s) Added to Cart Successfully.",getLayoutInflater());
        ...
        option_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(D_OrderHistoryDetails.this, v);
    ...
    private void setActionBar() {
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                appPrefs = new AppPrefs(D_OrderHistoryDetails.this);
                appPrefs.setUser_notification("D_OrderHistoryDetails");
    ...
    public class CustomResultAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (!bean_cart.get(position).getScheme_type().equalsIgnoreCase("2")) {
                ...
                if (bean_cart.get(position).getScheme_type().toString().equalsIgnoreCase("1") || bean_cart.get(position).getScheme_type().toString().equalsIgnoreCase("3")) {
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        // Globals.CustomToast(Product_List.this, "Item insert in cart", getLayoutInflater());
                        Intent i = new Intent(D_OrderHistoryDetails.this, D_OrderHistoryDetails.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                    }
